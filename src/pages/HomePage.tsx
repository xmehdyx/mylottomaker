    ...
    <div>
              ...
              <div className="relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-3xl font-bold text-accent-400 animate-glow">
                      {formatCurrency(totalPrizePool)} ETH
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card variant="glass" className="text-center">
          ...
          <p className="text-2xl font-bold text-secondary-400">
            {activeLotteries.reduce((sum, lottery) => sum + Math.floor(lottery.ticketsSold * 0.7), 0)}
          </p>
        </Card>
      </div>
      ...
      <div className="mb-8">
        <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsList className="bg-dark-700 p-1 rounded-lg">
            ...
            <TabsTrigger value="standard" active={activeTab === 'standard'}>
              Standard ({standardLotteries.length})
            </TabsTrigger>
            <TabsTrigger value="user" active={activeTab === 'user'}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          <Card variant="glass">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold">Top Winners</h2>
              <Button variant="ghost" size="sm" icon={<ChevronRight size={16} />} iconPosition="right">
                View All
              </Button>
            </div>
